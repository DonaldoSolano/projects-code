...
while True:    
    ...
    if(state == 1):
            ...
            frame_counter += 1
            if r == True:
                relojFrame=cv2.resize(relojFrame,(1366,768))
    ...
    if(state ==3):
        if(text=="Occupied"):
            ...
            if  imageRead == True:
                ...
                resultado = dst + dsp
                cv2.rectangle(resultado,(100,100),(500,500),(0,255,0),0)
                for(x,y,w,h) in hands:
                    cv2.rectangle(resultado,(x,y),(x+w,y+h),(0,255,0),2)
                    overlay=cv2.addWeighted(resultado[100:100+width,100:100+height],0,overlay,1,0)
                    resultado[100:100+width,100:100+height] = overlay
